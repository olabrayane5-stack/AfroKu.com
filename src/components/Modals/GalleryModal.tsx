...
export const BENIN_CULTURAL_PHOTOS: GalleryPhoto[] = [
  {
    ...
    category: 'Patrimoine',
    url: 'https://www.flyingfourchette.com/wp-content/uploads/2014/01/Ganvie-39.jpg',
  ...
  },
  {
    ...
    department: 'Atlantique',
    category: 'Patrimoine',
    url: 'https://live.staticflickr.com/8514/8388438993_66b63287fe_b.jpg',
  ...
  },
  {
    ...
    department: 'Zou',
    category: 'Artisanat',
    url: 'https://oukoikan.com/wp-content/uploads/2025/08/kanvo-1200x600.webp',
  ...
  },
  {
    ...
    url: 'https://i.pinimg.com/originals/bc/ee/cf/bceecfb39a8c5f5314f28efe18cea7a8.jpg',
  ...
  },
  {
    ...
    url: 'https://fongbebenin.com/tourisme/pendjari-elephants.jpg',
  ...
  },
  {
    ...
    url: 'https://www.gouv.bj/upload/images/banners/452600357145001705315348.jpg',
  ...
  },
  {
    ...
    department: 'Zou',
    category: 'Patrimoine',
    url: 'https://thumbs.dreamstime.com/b/generated-image-369009162.jpg',
  ...
  },
  {
    ...
    department: 'Plateau',
    category: 'Culture & Vaudou',
    url: 'https://www.chateau-vodou.com/wp-content/uploads/2022/10/V1516_08-scaled.jpg',
